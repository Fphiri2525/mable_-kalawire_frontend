...
export default function TopBar({ isDarkMode, onToggleTheme, userEmail }: TopBarProps) {
  ...
  return (
    <header className={`fixed top-0 right-0 left-64 h-16 z-20 transition-all duration-300 ${
      isDarkMode 
